...
const verifyEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const verificationToken = yield emailVerification_1.default.findOne({
        owner: userId,
    });
    if (!verificationToken)
        return res.status(403).json({ error: "Invalid token!" });
    const mathed = yield verificationToken.compareToken(token);
    if (!mathed)
        return res.status(403).json({ error: "Invalid token!" });
    yield user_1.default.findByIdAndUpdate(userId, {
        verified: true,
    });
    yield emailVerification_1.default.findByIdAndDelete(verificationToken._id);
...
const sendReVerificationToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user)
        return res.status(403).json({ error: "Invalid request!" });
    yield emailVerification_1.default.findOneAndDelete({
        owner: userId,
    });
    const token = (0, helper_1.generateToken)();
    yield emailVerification_1.default.create({
